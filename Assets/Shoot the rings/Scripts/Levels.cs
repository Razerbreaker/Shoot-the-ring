...
public class Levels : MonoBehaviour
{
    ...
    {
        SetRingsCountOnlvl(54);

        shootTheRing.DisableColorButton(0, false);  // - red button
        shootTheRing.DisableColorButton(1, false);  // - green button
        shootTheRing.DisableColorButton(2, false);  // - blue button
